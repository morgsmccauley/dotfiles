...
local window = {
  ...
  r = { '<C-w>r', 'Rotate' },
  c = { '<Cmd>lua require("plugins/navigation/leap/leap").leap_to_window()<Cr>', 'Choose window' },
  C = { '<Cmd>lua require("plugins/navigation/leap/leap").close_window()<Cr>', 'Close target window' },
...
local git = {
  name = '+git',
  l = { '<Cmd>lua require\'plugins/navigation/telescope/telescope\'.commits()<Cr>', 'Log' },
  p = { '<Cmd>Telescope gh pull_request<Cr>', 'Pull requests' },
  i = { '<Cmd>Telescope gh issues<Cr>', 'Issues' },
  b = { '<Cmd>lua require\'plugins/navigation/telescope/telescope\'.branches()<Cr>', 'Branches' },
  s = { '<Cmd>lua require\'plugins/navigation/telescope/telescope\'.stash()<Cr>', 'Stash' },
  c = { '<Cmd>Git commit<Cr>', 'Commit' },
  L = { '<Cmd>lua require\'plugins/navigation/telescope/telescope\'.bcommits()<Cr>', 'Buffer log' },
