...
local git = {
  name = '+git',
  l = { '<Cmd>lua require\'plugins/config/telescope-nvim\'.commits()<Cr>', 'Log' },
  p = { '<Cmd>Telescope gh pull_request<Cr>', 'Pull requests' },
  i = { '<Cmd>Telescope gh issues<Cr>', 'Issues' },
  b = { '<Cmd>lua require\'plugins/config/telescope-nvim\'.branches()<Cr>', 'Branches' },
  s = { '<Cmd>lua require\'plugins/config/telescope-nvim\'.stash()<Cr>', 'Stash' },
  c = { '<Cmd>Git commit<Cr>', 'Commit' },
  L = { '<Cmd>lua require\'plugins/config/telescope-nvim\'.bcommits()<Cr>', 'Buffer log' },
...
local jira = {
  name = '+jira',
  l = { '<Cmd>lua require\'plugins/config/telescope-nvim\'.jira()<Cr>', 'List Issues' }
}
...
local mappings = {
  ...
  [','] = { '<Cmd>lua require\'plugins/config/telescope-nvim\'.buffers()<Cr>', 'Switch buffer' },
